...
export const User = () => {
  ...
  const getUserDetails = async () => {
    ...
    await axios
      .get("http://localhost:2002/auth/usersdetails", config)
      .then((res) => {
    ...
    <div className=" w-full my-9 ">
      <div className=" w-full md:w-5/6 md:m-auto lg:w-5/6 lg:m-auto flex justify-between px-2 ">
        ...
        <div>
          <h2 className=" capitalize font-body text-lg">
            hey! <span className=" text-red-500"></span>
          </h2>
        </div>
      </div>
      <div className=" md:hidden lg:hidden">
        ...
        <div className=" w-full px-3  ">
          <h2 className=" capitalize  font-body text-2xl font-medium cursor-default">
            account settings
          </h2>
          <div className=" w-full grid gap-5 py-2">
            <div className=" w-full flex justify-between ">
              <div className=" w-2/3 flex items-center gap-1">
                <FaChevronRight />
                <Link to={"/editprofile"}>
                  <p className=" capitalize font-body text-xl cursor-pointer">
                    edit profile
                  </p>
                </Link>
              </div>
      ...
      <div className=" hidden md:w-5/6 lg:w-5/6 lg:m-auto lg:flex md:m-auto md:flex px-2 py-5">
        <div className=" w-1/4 ">
          <div className=" w-full ">
            <h2 className=" capitalize font-body text-lg font-semibold cursor-pointer">
              my account
            </h2>
            <div className=" w-5/6 m-auto grid gap-2 py-4">
              <Link>
                <p className=" capitalize font-body text-sm text-gray-400 hover:text-red-500">
                  my profile
                </p>
              </Link>
              <Link>
          ...
          <div>
            <Link to={"/wishlist"}>
              <h2 className=" capitalize font-body font-semibold text-lg">
                my wishlist
              </h2>
            </Link>
          </div>
        ...
        <div className=" w-3/5 m-auto  px-10 py-4 shadow-lg ">
          <h2 className=" w-full font-body capitalize text-xl text-left text-red-500">
            edit your profile
          </h2>
          <div className=" grid gap-3 py-3">
            <div className=" flex justify-between ">
              <div className=" w-full grid gap-1">
                ...
                <input
                  ...
                  className=" w-11/12 px-2 py-2 bg-slate-100"
                />
              </div>
              <div className=" w-full grid gap-1">
                ...
                <input
                  type=" text"
                  placeholder="Luffy"
                  className=" w-full px-2 py-2 bg-slate-100"
                />
              </div>
            </div>
            <div className=" flex justify-between ">
              <div className=" w-full grid gap-1">
                ...
                <input
                  type=" text"
                  placeholder=" luffypirate1998@gmail.com"
                  className=" w-11/12 px-2 py-2 bg-slate-100"
                />
              </div>
              <div className=" w-full grid gap-1">
                ...
                <input
                  type=" text"
                  placeholder="No.7,Strawhat Pirates,One Piece"
                  className=" w-full px-2 py-2 bg-slate-100"
                />
              </div>
            </div>
            <div className=" w-full">
              ...
              <div className=" w-full grid gap-3 py-3">
                <input
                  ...
                  className=" px-2 py-2 w-full bg-slate-100 "
                />
                <input
                  type=" password"
            ...
            <div className=" w-full flex justify-end gap-2">
              <Link>
                <button className=" capitalize font-body px-2 py-2 hover:bg-red-500 hover:text-white">
                  cancel
                </button>
              </Link>
              <Link>
                <button className=" capitalize font-body px-2 py-2 bg-red-500 text-white">
                  save changes
                </button>
              </Link>
            </div>
